...
<template>
    <div class="theme-rustic-forest min-h-screen relative pb-12">
        ...
        <div v-if="music" class="fixed bottom-6 right-6 z-50">
            ...
            <button 
                ...
                :class="isPlaying ? 'animate-spin-slow bg-amber-800 text-white border-amber-700' : 'bg-stone-100 text-stone-750 border-stone-250'"
            >
        ...
        <!-- Rustic Separation Divider -->
        <div class="flex justify-center items-center py-6 rustic-divider">
            <div class="h-[1px] w-24 bg-amber-800/30"></div>
            <span class="mx-4 text-amber-800/60 text-lg">🌿</span>
            <div class="h-[1px] w-24 bg-amber-800/30"></div>
        </div>
