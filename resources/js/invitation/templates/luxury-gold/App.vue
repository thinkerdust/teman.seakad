...
<template>
    <div class="theme-luxury-gold min-h-screen relative pb-12">
        ...
        <div v-if="music" class="fixed bottom-6 right-6 z-50">
            ...
            <button 
                ...
                :class="isPlaying ? 'animate-spin-slow bg-amber-500 text-slate-950 border-amber-400' : 'bg-stone-900 text-amber-100 border-amber-500/30'"
            >
        ...
        <!-- Luxury Separation Divider -->
        <div class="flex justify-center items-center py-6 luxury-divider">
            <div class="h-[1px] w-24 bg-amber-500/40"></div>
            <span class="mx-4 text-amber-400 font-serif text-lg">✦</span>
            <div class="h-[1px] w-24 bg-amber-500/40"></div>
        </div>
