    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-5xl mx-auto">
            ...
            <div class="bg-white border border-rose-gold-100/35 p-8 rounded-2xl flex flex-col justify-between hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900 transition duration-300">
                ...
                <div class="mt-8">
                    <a href="{{ route('login') }}" class="block w-full text-center py-3 px-6 rounded-xl text-xs font-bold border border-rose-gold-300 text-rose-gold-600 hover:bg-rose-gold-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800 transition duration-300">
                        Mulai Gratis
                    </a>
                </div>
            </div>
            ...
            <div class="relative bg-white border-2 border-rose-gold-400 p-8 rounded-2xl flex flex-col justify-between shadow-xl shadow-rose-gold-500/5 dark:bg-zinc-900 transition duration-300 transform scale-100 lg:scale-[1.03] z-10">
                ...
                <div class="mt-8">
                    <a href="{{ route('login') }}" class="block w-full text-center py-3.5 px-6 rounded-xl text-xs font-bold bg-gradient-to-r from-rose-gold-500 to-rose-gold-600 text-white shadow-md shadow-rose-gold-500/10 hover:shadow-lg transition duration-300">
                        Pilih Premium
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white border border-rose-gold-100/35 p-8 rounded-2xl flex flex-col justify-between hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900 transition duration-300">
                ...
                <div class="mt-8">
                    <a href="https://wa.me/6281234567890" target="_blank" class="block w-full text-center py-3 px-6 rounded-xl text-xs font-bold border border-rose-gold-300 text-rose-gold-600 hover:bg-rose-gold-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800 transition duration-300">
