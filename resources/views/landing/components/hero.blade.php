    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10 w-full">
        ...
        <div class="lg:col-span-7 text-center lg:text-left space-y-8">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 hero-cta">
                <a href="{{ $whatsappOrderUrl }}" target="_blank" rel="noopener noreferrer" class="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full text-base font-bold text-center bg-gradient-to-r from-green-500 to-green-600 text-white shadow-xl shadow-green-500/20 hover:shadow-2xl hover:shadow-green-500/35 hover:scale-[1.03] transition-all duration-300">
                    {{-- Ikon WhatsApp --}}
