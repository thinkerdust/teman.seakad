<section class="py-16 px-6 border-b border-[var(--theme-secondary)]/30 space-y-8" {!! themeAnimation('rsvp') !!}>
    <div class="text-center space-y-2">
        <h2 class="font-heading text-2xl text-[var(--theme-primary)] font-bold uppercase tracking-widest" style="font-family: var(--theme-font-heading);">Konfirmasi Kehadiran</h2>
    ...
    >
        <div>
            ...
            <input 
                ...
                class="w-full rounded-xl border border-[var(--theme-secondary)] bg-[var(--theme-surface)]/80 px-4 py-3 text-sm text-[var(--theme-text)] placeholder-[var(--theme-text)]/40 focus:border-[var(--theme-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--theme-primary)] transition duration-200 font-body"
        ...
        <button 
            type="submit" 
            :disabled="loading"
            class="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-accent)] text-[var(--theme-surface)] hover:opacity-90 font-bold text-sm uppercase tracking-widest shadow-md transition duration-300 disabled:opacity-50 cursor-pointer"
        >
