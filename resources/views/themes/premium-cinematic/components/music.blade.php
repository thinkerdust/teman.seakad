...
>
    ...
    <div class="relative flex items-center justify-center">
        ...
        <button 
            ...
            :style="isPlaying ? 'background: linear-gradient(135deg, var(--theme-primary), var(--theme-accent)); color: var(--theme-surface); box-shadow: 0 0 15px var(--theme-primary);' : 'background-color: var(--theme-surface); color: var(--theme-text);'"
            title="Musik Latar"
        >
            <!-- Playing state icon -->
