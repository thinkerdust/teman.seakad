        ...
        @if(count($invitationData['events']) > 0)
            <div class="space-y-6 max-w-md mx-auto">
                @foreach($invitationData['events'] as $event)
                    <div class="event-card bg-[var(--theme-surface)] p-6 sm:p-8 rounded-2xl border border-[var(--theme-secondary)] shadow-sm flex flex-col justify-between relative overflow-hidden text-left" data-gsap="fade-up" style="border-radius: 1rem 0 1rem 0;">
                        ...
                        @if($invitationData['maps_url'])
                            <div class="mt-6 pt-4 border-t border-[var(--theme-secondary)]/50 event-card-footer">
                                <a 
                                    ...
                                    style="border-radius: 0.5rem 0 0.5rem 0;"
                                >
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
