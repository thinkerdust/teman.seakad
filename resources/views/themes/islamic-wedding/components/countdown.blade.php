<section class="countdown-section py-12 px-4 text-center border-b border-[var(--theme-secondary)]/50" {!! themeAnimation('countdown') !!}>
    <div class="max-w-xl mx-auto">
        ...
        >
            <!-- Hari -->
            <div class="countdown-card flex flex-col justify-center items-center p-3 sm:p-4 border border-[var(--theme-secondary)]/40 backdrop-blur-md bg-[var(--theme-surface)]/60 shadow-md" style="border-radius: 1rem 0 1rem 0;">
