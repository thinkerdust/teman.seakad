        ...
        @if(count($invitationData['gallery']) > 0)
            <div class="grid grid-cols-2 gap-3 max-w-md mx-auto">
                @foreach($invitationData['gallery'] as $photo)
                    <div 
                        class="gallery-item-wrapper relative aspect-square overflow-hidden group cursor-pointer border border-[var(--theme-secondary)] bg-[var(--theme-surface)] shadow-sm"
