...
>
    ...
    <button 
        ...
        class="h-12 w-12 rounded-full flex items-center justify-center shadow-lg focus:outline-none transition duration-300 border border-stone-200 cursor-pointer"
        :style="isPlaying ? 'background-color: var(--primary, #8b5a2b); color: white;' : 'background-color: white; color: black;'"
        title="Musik Latar"
    >
        <!-- Playing state icon -->
