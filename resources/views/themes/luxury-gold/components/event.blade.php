        ...
        @if(count($invitationData['events']) > 0)
            <div class="space-y-6 max-w-md mx-auto">
                @foreach($invitationData['events'] as $event)
                    <div class="event-card bg-[var(--theme-surface)] p-6 sm:p-8 rounded-2xl border border-[var(--theme-secondary)] shadow-sm flex flex-col justify-between relative overflow-hidden text-left" data-gsap="fade-up" style="border-radius: 2px;">
