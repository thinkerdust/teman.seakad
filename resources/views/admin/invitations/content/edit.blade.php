    ...
    >
        ...
        <div class="mt-4">
            ...
            <div x-show="activeTab === 'music'" x-cloak class="space-y-6">
                ...
                <x-admin.card title="Musik Latar Terpasang">
                    @if($invitation->music)
                        <div class="rounded-xl border border-slate-150 bg-slate-50/50 p-5 dark:border-slate-800 dark:bg-slate-900/30 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-slate-800 dark:text-white text-sm">Background_Music.mp3</h4>
                                    <p class="text-xs text-slate-400 dark:text-slate-500 mt-0.5">
                                        Tautan berkas: <a href="{{ $invitation->music->file }}" target="_blank" class="text-indigo-600 dark:text-indigo-400 hover:underline break-all">{{ basename($invitation->music->file) }}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="flex-grow max-w-md">
                                <audio controls class="w-full focus:outline-none">
                                    <source src="{{ $invitation->music->file }}" type="audio/mpeg">
                                    <source src="{{ $invitation->music->file }}" type="audio/wav">
                    ...
                    @else
                        <div class="flex flex-col items-center justify-center py-10 text-center">
                            ...
                            <h4 class="mt-4 font-semibold text-slate-800 dark:text-white">Musik Latar Belum Terpasang</h4>
                            <p class="mt-1 text-sm text-slate-400 dark:text-slate-500 max-w-xs">
                                Unggah berkas audio di bawah untuk memasang musik latar otomatis yang akan diputar saat tamu membuka undangan digital Anda.
                            </p>
                        </div>
                    @endif
                </x-admin.card>
                ...
                <!-- Music Upload Card -->
                <x-admin.card title="Unggah Musik Latar">
                    <form 
                        action="{{ route('admin.invitations.content.music', $invitation->id) }}" 
                        method="POST" 
                        enctype="multipart/form-data"
                    ...
                    >
                        ...
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-end">
                            <div class="flex-grow">
                                <label class="block text-sm font-semibold text-slate-700 dark:text-slate-350 mb-2">Pilih File Musik (MP3 / WAV)</label>
                                <div class="relative flex items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50/50 p-6 text-center hover:bg-slate-55 transition dark:border-slate-700 dark:bg-slate-900/50">
                                    <input 
                                        type="file" 
                                        name="music_file" 
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="text-xs text-slate-550 dark:text-slate-400">
                                            <span class="font-semibold text-indigo-600 hover:text-indigo-500">Pilih file audio</span> atau seret berkas ke sini
                                        </div>
                                        <p class="text-xxs text-slate-400">Format MP3 atau WAV, Ukuran Maksimal 20MB</p>
                                    </div>
                                </div>
                            </div>
                            <button 
