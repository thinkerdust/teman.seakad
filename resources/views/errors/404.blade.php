...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Teman Seakad</title>
    <!-- Google Fonts -->
...
<body class="h-full bg-slate-950 text-slate-100 flex items-center justify-center p-4 overflow-hidden relative">
    ...
    <div class="glow-blob absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-violet-600/10 pointer-events-none"></div>

    <!-- Main Container -->
    <div class="max-w-md w-full text-center relative z-10">
        
        <!-- Animated 404 Icon / Card -->
        <div class="inline-block animate-float mb-8">
            <div class="relative flex items-center justify-center w-28 h-28 rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl mx-auto">
                <svg class="h-14 w-14 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <h1 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">Halaman Tidak Ditemukan</h1>
        
        <p class="mt-4 text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
            Maaf, halaman yang Anda cari tidak dapat kami temukan atau mungkin telah dihapus permanen dari sistem.
        </p>
