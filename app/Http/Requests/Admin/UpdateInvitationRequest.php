...
class UpdateInvitationRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        // Superadmin & Admin dapat memperbarui semua undangan
        if ($user->hasRole('Superadmin') || $user->hasRole('Admin') || $user->email === 'admin@teman-seakad.com') {
            return true;
        }

        // User biasa hanya dapat memperbarui undangan miliknya sendiri
        return $invitation && $invitation->user_id === $user->id;
    }
